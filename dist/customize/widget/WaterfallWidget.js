define("customize/widget/WaterfallWidget", [ "commonui/waterfall/Waterfall", "core/class/Class", "core/event/EventEmitter", "core/util/Utils", "core/view/View", "juicer", "lib/juicer" ], function(require, exports, module) {
    "use strict";
    ...
    juicer = require("lib/juicer"), template = juicer('<div class="ui-viewport"><ul class="ui-waterfall"></ul></div>', {});
    return View.extend({
