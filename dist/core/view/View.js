define("core/view/View", [ "../class/Class", "../event/EventEmitter", "../util/Utils", "lib/juicer" ], function(require, exports, module) {
    "use strict";
    var Class = require("../class/Class"), EventEmitter = require("../event/EventEmitter"), Utils = require("../util/Utils"), juicer = require("lib/juicer"), root = {
        $el: $(document.body),
        children: []
    };
    return Class.extend({
